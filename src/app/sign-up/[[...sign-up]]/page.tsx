  ...
  return (
    <main className="flex items-center justify-center min-h-screen bg-teal-950/40">
      <div className="w-full max-w-md rounded-2xl bg-white/10 p-8 backdrop-blur">
        ...
        <p className="text-white/70 mb-6">Enter an email and password to get started.</p>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={!canSubmit}
            className="w-full rounded-full bg-gradient-to-r from-teal-400 to-teal-500 px-6 py-3 font-semibold text-slate-900 shadow-lg shadow-teal-500/20 disabled:opacity-50"
          >
            Create account
          </button>
        </form>
        ...
        <p className="mt-6 text-sm text-white/70">
          Already have an account? <a className="font-semibold text-white" href="/sign-in">Sign in</a>
        </p>
      </div>
    </main>
  );
