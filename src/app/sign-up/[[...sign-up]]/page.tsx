  ...
  return (
    <main className="flex items-center justify-center min-h-screen bg-teal-950/40">
      <div className="w-full max-w-4xl rounded-2xl bg-white/10 p-12 backdrop-blur">
        <h1 className="text-5xl font-semibold text-white mb-4">Create your account</h1>
        <p className="text-lg text-white/70 mb-8">Enter an email and password to get started.</p>
