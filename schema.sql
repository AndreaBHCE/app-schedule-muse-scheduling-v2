-- ScheduleMuseAI — D1 Schema (canonical source of truth)
-- Personal scheduling platform (user IS the provider)
--
-- This file is the ONLY schema definition. The seed route reads it directly.
-- Do NOT duplicate CREATE TABLE statements elsewhere.
--
...
-- ────────────────────────────────────────────────
-- Integrations (Zoom, Gmail, SMTP, etc.)
-- ────────────────────────────────────────────────
