...
## Project Context
ScheduleMuse AI — Next.js scheduling platform on Cloudflare (D1 database, Workers). Integrations: Gmail OAuth (restricted scope: gmail.send), Zoom, Google Calendar. Auth via Clerk. All OAuth tokens encrypted AES-256-GCM. Production domain: app.schedulemuseai.com.
